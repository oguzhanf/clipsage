...
Write-Host "Building ClipperMVP..." -ForegroundColor Cyan
...
try {
    ...
    $zipPath = Join-Path $PSScriptRoot "bin\ClipperMVP-Setup-$version.zip"
    $msiPath = Join-Path $PSScriptRoot "bin\ClipperMVP-Setup-$version.msi"
